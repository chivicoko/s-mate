...
from .views import home, teacher, teacher_add_question, teacher_add_test, student, student_past_questions, student_subjects, blog, post_detail, success, new_blog_post, register_view, login_view, logout_view
